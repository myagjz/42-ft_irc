...
void Server::welcomemsg(int fd)
{
	...
	welcome.append(" ╚══╝╚══╝ ╚══════╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝\n");
	welcome.append(BLEU);
	welcome.append("\nYou need to login so you can start chatting OR you can send HELP to see how :) \n");
	welcome.append(BD);
	this->sender(fd, welcome);
}
...
{
	//std::cout << "Send -> Fd[" << fd << "]: \n" << msg << std::endl; //for Server console to track
