...
SRCS = srcs/Channel.cpp srcs/Client.cpp srcs/main.cpp srcs/Server.cpp \
        srcs/commands/HELP.cpp srcs/commands/JOIN.cpp srcs/commands/KICK.cpp \
        srcs/commands/NICK.cpp srcs/commands/OP.cpp srcs/commands/PART.cpp \
        srcs/commands/PASS.cpp srcs/commands/PRIVMSG.cpp srcs/commands/QUIT.cpp \
