...
#define RPL_PART(nick, channelName) (":" + nick + " PART " + channelName + "\n")

/* 001 */ #define RPL_WELCOME(client) ":IRC 001 " + client->getNickname() + " :Welcome to the IRC network, " + client->getNickname() + "!" + "\n"
/* 001 */ #define RPL_WELCOMECOM(client) ":IRC 001 " + client->getNickname() + " : Commands -> INVITE, JOIN, KICK, MODE, NICK, PART, PASS, PRIVMSG, QUIT, TOPIC, USER" + client->getNickname() + " <-" + "\n"
...
/* 442 */ #define ERR_NOTONCHANNEL(user, channelName) (user->getNickname() + " :You're not on that channel" + "\n")
